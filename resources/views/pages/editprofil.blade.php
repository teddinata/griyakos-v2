            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 pl-lg-0">
                        ...
                        <form action="{{route('editprofil.update', $user->id)}}" method="post" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            @if (session('berhasil'))
                               ...
                               <!-- <input type="hidden" name="_token" value="" >
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        id="birth" name="birth" placeholder="Tanggal Lahir" value data-type="{{$user->birth}}">
